...
public class GneUserDto {
     ...
     *         , "dedicatedYn" : "Y"
     *         , "confmSttusCode" : "C"
     *         , "dedicatedDetail" : [{"subject":"국어","gradeList":{"5":["4","5","6"]}},{"subject":"도덕","gradeList":{"5":["1","2","3"],"6":["1","2","3","4","5"]}}]},"files":"","wireData":""
     *         , "count":1
     *     }
     */
    ...
    private String homeroomAt;     // 담임여부(Y: 담임)
    private Map<String, List<GneTxtbkDto>> txtbkList;
}
